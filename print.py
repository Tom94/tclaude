...
def write_user_message(message: dict, io: StringIO, pretty: bool):
...
def write_assistant_message(message: dict, io: StringIO):
    references = {}
...
def history_to_string(history: list[dict], pretty: bool, wrap_width: int | None = None) -> str:
    ...
    for message in history:
        if message["role"] == "system":
            ...
            write_user_message(message, io, pretty)
        elif message["role"] == "assistant":
            write_assistant_message(message, io)
